...
class AgenticRun:
    ...
    def execute(self) -> str:
        ...
        from .notebook_exec import notebook_mode_enabled
        ...
        if notebook_mode_enabled():
            ...
            # markdown cells hold the writeup). Do NOT write solution.md — stamp
            # run provenance as a trailing metadata cell + notebook metadata.
            ...
            (self.study_dir / "solution.md").write_text(
                f"# Solution\n\n{report}\n\n" + meta_md, encoding="utf-8")
