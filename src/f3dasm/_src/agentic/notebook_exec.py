...
def notebook_deliverable_spec(role: str = "strategizer") -> str:
    ...
    if role == "strategizer":
        intro = (
            ...
            "  - EditPipelineCell(phase, why?, code?): patch an existing pillar's\n"
            "    code OR why in place, without re-supplying the other.\n"
            "  - DeletePipelineCell(phase): drop a pillar you decided not to run\n"
            "    (don't leave dead/placeholder code in the deliverable).\n"
    ...
    return (
        ...
        "  immediately re-call AddPipelineCell or EditPipelineCell to update both the\n"
